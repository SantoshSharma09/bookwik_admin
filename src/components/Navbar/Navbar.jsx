...
const Navbar = () => {
  ...
  function logoutfun() {
    localStorage.clear();
    window.location.href = "https://bookwik-project.vercel.app/";
  }
  ...
  return (
    <>
      <div className="admin_navabr_start">
        <img
          src={images_logo_admin}
          alt="nav_logo_admin"
          className="nav_admin_logo_img"
          onClick={homepagehandle}
        />
        <DropdownButton
          title={adminemail}
          className="mainnav_dashboard_admin_email"
        >
          <Dropdown.Item onClick={logoutfun} style={{ textDecoration: "none" }}>
            logout
          </Dropdown.Item>
        </DropdownButton>
      </div>
